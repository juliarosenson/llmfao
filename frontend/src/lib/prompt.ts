...
- No Matching Source: Use Static (with appropriate default) or Blank
- Multiple Source Options: Choose the most complete and reliable field
- Unclear Formats: Make reasonable assumptions and document in notes
- Missing Required Data: Use Static with sensible defaults per CRM requirements
